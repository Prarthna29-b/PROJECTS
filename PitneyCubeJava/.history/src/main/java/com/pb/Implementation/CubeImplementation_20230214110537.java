...
public class CubeImplementation {
	...
	public CubeResult connectPrinter(2,null,0,0,0,0 ) {
		CubeResult	pc = new CubeResult(false, 0, null);
		int res2 = cubeDLL.ConnectPrinterEx(int nInterface, String szPortName, int nBaudRate, int nDataBits, int nParity, int nStopBits);
	...
	public CubeResult getScaleVersion(byte version[]) {
		CubeResult pc = new CubeResult(false, 0, null);
		 version = new byte[48];
