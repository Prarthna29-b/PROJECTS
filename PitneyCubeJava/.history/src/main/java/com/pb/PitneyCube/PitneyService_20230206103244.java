...
public class PitneyService {
	PitneyCubeInterface cubeDLL = PitneyCubeInterface.INSTANCE;
PitneyCube pc= new PitneyCube();
	public void getConnectPrinter(int nInterface, String nPortName, int nBaudRate, int nDataBits, int nParity,
			int nStopBits) {
				PitneyCube pc= new PitneyCube();
