...
public interface PitneyCube extends Library {
	...
	public int ConnectPrinterEx(int nInterface, String szPortName, int nBaudRate, int nDataBits, int nParity, int nStopBits);
	...
	int GetScaleGravityInformation(byte[] gravity);
