...
public interface PitneyCubeInterface extends Library {
	PitneyCubeInterface INSTANCE = (PitneyCubeInterface) Native.load(("PrinterandScaleAPI_x64"),
			PitneyCubeInterface.class);
	...
	Long GetPB_ProductNumber (byte[] Number); 
	Long GetPB_SerialNumber (byte[] Number);
}
