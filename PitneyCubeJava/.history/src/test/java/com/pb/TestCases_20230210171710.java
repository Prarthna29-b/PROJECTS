...
public class TestCases {
	...
	public void testNoPrinter()
	 {
		System.out.println(ps.connectPrinter(2, new String(), 0, 0, 0, 0));
		when(pitneycube
	...
	public void testWeights() {
		...
		CubeResult ex = new CubeResult(true, 1660944384, null);
		ps = new CubeImplementation();
	...
	public void testVersion() {
		...
		CubeResult ex = new CubeResult(true,1ps = new CubeImplementation(); , null);
		ps = new CubeImplementation();
