...
public class TestCases {
	...
	public void testConnectionSuccess() {
		...
		CubeResult expect=ps.connectPrinter();
	...
	public void testNoPrinter()
	 {
		...
		.thenReturn(71);
		CubeResult actual= new CubeResult(false,0,"No printers available to connect");
		CubeResult excepted=ps.connectPrinter();
		assertEquals(excepted.toString(), act.toString());
	}
