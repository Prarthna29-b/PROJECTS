...
public class TestCases {
	...
	public void testConnect() {
		...
		Mockito.lenient().when(null)
		when(pitneycube.ConnectPrinterEx(0, null, 0, 0, 0, 0)).thenReturn(0);
		// Mockito.when(ps.connectPrinter()).thenReturn(cr);
		assertEquals(cr, ps.connectPrinter(0, null, 0, 0, 0, 0));
		// assertEquals(r, service.connectPrinter(2, null, 0, 0, 0, 0))
	}
}
//
